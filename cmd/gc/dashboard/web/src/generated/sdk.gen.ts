 ...
 */
export const supervisorSecretsStatus = <ThrowOnError extends boolean = false>(options?: Options<SupervisorSecretsStatusData, ThrowOnError>) => (options?.client ?? client).get<SupervisorSecretsStatusResponses, SupervisorSecretsStatusErrors, ThrowOnError>({ url: '/v1/supervisor/secrets/status', ...options });
